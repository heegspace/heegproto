...
var file_certnode_proto_rawDesc = []byte{
	...
	0x03, 0x0a, 0x0f, 0x43, 0x65, 0x72, 0x74, 0x6e, 0x6f, 0x64, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x12, 0x40, 0x0a, 0x0a, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x43, 0x65, 0x72, 0x74,
	0x12, 0x17, 0x2e, 0x63, 0x65, 0x72, 0x74, 0x6e, 0x6f, 0x64, 0x65, 0x2e, 0x53, 0x75, 0x62, 0x6d,
	0x69, 0x74, 0x43, 0x65, 0x72, 0x74, 0x52, 0x65, 0x71, 0x1a, 0x17, 0x2e, 0x63, 0x65, 0x72, 0x74,
	...
	,
...
var file_certnode_proto_depIdxs = []int32{
	...
	0,  // 33: certnode.CertnodeService.SubmitCert:input_type -> certnode.SubmitCertReq
	6,  // 34: certnode.CertnodeService.CertInfo:input_type -> certnode.CertInfoReq
	8,  // 35: certnode.CertnodeService.CertFlow:input_type -> certnode.CertFlowReq
	10, // 36: certnode.CertnodeService.CertCancel:input_type -> certnode.CertCancelReq
	2,  // 37: certnode.CertnodeService.CertApproved:input_type -> certnode.CertApprovedReq
	4,  // 38: certnode.CertnodeService.CertRefuse:input_type -> certnode.CertRefuseReq
	12, // 39: certnode.CertnodeService.CertCache:input_type -> certnode.CertCacheReq
	1,  // 40: certnode.CertnodeService.SubmitCert:output_type -> certnode.SubmitCertRes
	7,  // 41: certnode.CertnodeService.CertInfo:output_type -> certnode.CertInfoRes
	9,  // 42: certnode.CertnodeService.CertFlow:output_type -> certnode.CertFlowRes
	11, // 43: certnode.CertnodeService.CertCancel:output_type -> certnode.CertCancelRes
	3,  // 44: certnode.CertnodeService.CertApproved:output_type -> certnode.CertApprovedRes
	5,  // 45: certnode.CertnodeService.CertRefuse:output_type -> certnode.CertRefuseRes
	13, // 46: certnode.CertnodeService.CertCache:output_type -> certnode.CertCacheRes
