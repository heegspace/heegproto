...
func (p SearchTyle) String() string {
	switch p {
	case SearchTyle_FROM_QUESTION:
		return "FROM_QUESTION"
	case SearchTyle_FROM_GRPAH:
		return "FROM_GRPAH"
	case SearchTyle_FROM_CLOUD:
		return "FROM_CLOUD"
	case SearchTyle_FROM_PRIVATE:
		return "FROM_PRIVATE"
	}
	return "<UNSET>"
}
...
func SearchTyleFromString(s string) (SearchTyle, error) {
	switch s {
	case "FROM_QUESTION":
		return SearchTyle_FROM_QUESTION, nil
	case "FROM_GRPAH":
		return SearchTyle_FROM_GRPAH, nil
	case "FROM_CLOUD":
		return SearchTyle_FROM_CLOUD, nil
	case "FROM_PRIVATE":
		return SearchTyle_FROM_PRIVATE, nil
	}
...
func (p TeacherStatus) String() string {
	switch p {
	case TeacherStatus_CREATE:
		return "CREATE"
	case TeacherStatus_APPROVING:
		return "APPROVING"
	case TeacherStatus_APPOVED:
		return "APPOVED"
	case TeacherStatus_PASSED:
		return "PASSED"
	case TeacherStatus_NOPASS:
		return "NOPASS"
	case TeacherStatus_LOGOUT:
		return "LOGOUT"
	}
	return "<UNSET>"
}
...
func TeacherStatusFromString(s string) (TeacherStatus, error) {
	switch s {
	case "CREATE":
		return TeacherStatus_CREATE, nil
	case "APPROVING":
		return TeacherStatus_APPROVING, nil
	case "APPOVED":
		return TeacherStatus_APPOVED, nil
	case "PASSED":
		return TeacherStatus_PASSED, nil
	case "NOPASS":
		return TeacherStatus_NOPASS, nil
	case "LOGOUT":
		return TeacherStatus_LOGOUT, nil
	}
...
func (p Teacher2userStatus) String() string {
	switch p {
	case Teacher2userStatus_FOCUS:
		return "FOCUS"
	case Teacher2userStatus_CANCEL:
		return "CANCEL"
	}
	return "<UNSET>"
}
...
func Teacher2userStatusFromString(s string) (Teacher2userStatus, error) {
	switch s {
	case "FOCUS":
		return Teacher2userStatus_FOCUS, nil
	case "CANCEL":
		return Teacher2userStatus_CANCEL, nil
	}
...
func (p NoteStatus) String() string {
	switch p {
	case NoteStatus_CREATE:
		return "CREATE"
	case NoteStatus_DELETE:
		return "DELETE"
	}
	return "<UNSET>"
}
...
func NoteStatusFromString(s string) (NoteStatus, error) {
	switch s {
	case "CREATE":
		return NoteStatus_CREATE, nil
	case "DELETE":
		return NoteStatus_DELETE, nil
	}
...
func CertTyoeFromString(s string) (CertTyoe, error) {
	switch s {
	case "ID":
		return CertTyoe_ID, nil
	case "FACE":
		return CertTyoe_FACE, nil
	}
...
type UpdateUserinfoField int64

const (
	UpdateUserinfoField_USER_EMAIL    UpdateUserinfoField = 1
	UpdateUserinfoField_USER_PASS     UpdateUserinfoField = 2
	UpdateUserinfoField_USER_AVATAR   UpdateUserinfoField = 3
	UpdateUserinfoField_USER_NICKNAME UpdateUserinfoField = 4
	UpdateUserinfoField_USER_SEX      UpdateUserinfoField = 5
)

func (p UpdateUserinfoField) String() string {
	switch p {
	case UpdateUserinfoField_USER_EMAIL:
		return "USER_EMAIL"
	case UpdateUserinfoField_USER_PASS:
		return "USER_PASS"
	case UpdateUserinfoField_USER_AVATAR:
		return "USER_AVATAR"
	case UpdateUserinfoField_USER_NICKNAME:
		return "USER_NICKNAME"
	case UpdateUserinfoField_USER_SEX:
		return "USER_SEX"
	}
	return "<UNSET>"
}

func UpdateUserinfoFieldFromString(s string) (UpdateUserinfoField, error) {
	switch s {
	case "USER_EMAIL":
		return UpdateUserinfoField_USER_EMAIL, nil
	case "USER_PASS":
		return UpdateUserinfoField_USER_PASS, nil
	case "USER_AVATAR":
		return UpdateUserinfoField_USER_AVATAR, nil
	case "USER_NICKNAME":
		return UpdateUserinfoField_USER_NICKNAME, nil
	case "USER_SEX":
		return UpdateUserinfoField_USER_SEX, nil
	}
	return UpdateUserinfoField(0), fmt.Errorf("not a valid UpdateUserinfoField string")
}

func UpdateUserinfoFieldPtr(v UpdateUserinfoField) *UpdateUserinfoField { return &v }

func (p UpdateUserinfoField) MarshalText() ([]byte, error) {
	return []byte(p.String()), nil
}

func (p *UpdateUserinfoField) UnmarshalText(text []byte) error {
	q, err := UpdateUserinfoFieldFromString(string(text))
	if err != nil {
		return err
	}
	*p = q
...
func (p *UpdateUserinfoField) Scan(value interface{}) error {
	v, ok := value.(int64)
	if !ok {
		return errors.New("Scan value is not int64")
	}
	*p = UpdateUserinfoField(v)
	return nil
}

func (p *UpdateUserinfoField) Value() (driver.Value, error) {
	if p == nil {
		return nil, nil
	}
	return int64(*p), nil
...
func (p LogType) String() string {
	switch p {
	case LogType_CREATE_USER:
		return "CREATE_USER"
	case LogType_UPDATE_USER:
		return "UPDATE_USER"
	case LogType_LOGIN_USER:
		return "LOGIN_USER"
	case LogType_LOGOUT_USER:
		return "LOGOUT_USER"
	case LogType_SUBMIT_CERT:
		return "SUBMIT_CERT"
	case LogType_CANCEL_CERT:
		return "CANCEL_CERT"
	case LogType_CERT_FAIL:
		return "CERT_FAIL"
	case LogType_CERT_SUCCESS:
		return "CERT_SUCCESS"
	case LogType_VIP_LEVELUP:
		return "VIP_LEVELUP"
	case LogType_COIN_APPEND:
		return "COIN_APPEND"
	case LogType_COIN_USED:
		return "COIN_USED"
	}
	return "<UNSET>"
}
...
func LogTypeFromString(s string) (LogType, error) {
	switch s {
	case "CREATE_USER":
		return LogType_CREATE_USER, nil
	case "UPDATE_USER":
		return LogType_UPDATE_USER, nil
	case "LOGIN_USER":
		return LogType_LOGIN_USER, nil
	case "LOGOUT_USER":
		return LogType_LOGOUT_USER, nil
	case "SUBMIT_CERT":
		return LogType_SUBMIT_CERT, nil
	case "CANCEL_CERT":
		return LogType_CANCEL_CERT, nil
	case "CERT_FAIL":
		return LogType_CERT_FAIL, nil
	case "CERT_SUCCESS":
		return LogType_CERT_SUCCESS, nil
	case "VIP_LEVELUP":
		return LogType_VIP_LEVELUP, nil
	case "COIN_APPEND":
		return LogType_COIN_APPEND, nil
	case "COIN_USED":
		return LogType_COIN_USED, nil
	}
...
type UpdateUserinfoItem struct {
	...
	Field     UpdateUserinfoField `thrift:"field,2" db:"field" json:"field"`
	NewValue_ string              `thrift:"new_value,3" db:"new_value" json:"new_value"`
	OldValue  string              `thrift:"old_value,4" db:"old_value" json:"old_value"`
	Extra     map[string]string   `thrift:"extra,5" db:"extra" json:"extra"`
}

func NewUpdateUserinfoItem() *UpdateUserinfoItem {
	return &UpdateUserinfoItem{}
}

func (p *UpdateUserinfoItem) GetUID() int64 {
	return p.UID
}

func (p *UpdateUserinfoItem) GetField() UpdateUserinfoField {
	return p.Field
}

func (p *UpdateUserinfoItem) GetNewValue_() string {
	return p.NewValue_
}

func (p *UpdateUserinfoItem) GetOldValue() string {
	return p.OldValue
}

func (p *UpdateUserinfoItem) GetExtra() map[string]string {
	return p.Extra
}
func (p *UpdateUserinfoItem) Read(iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
	}
...
func (p *UpdateUserinfoItem) ReadField1(iprot thrift.TProtocol) error {
...
func (p *UpdateUserinfoItem) ReadField2(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI32(); err != nil {
		return thrift.PrependError("error reading field 2: ", err)
	} else {
		temp := UpdateUserinfoField(v)
		p.Field = temp
	}
	return nil
}

func (p *UpdateUserinfoItem) ReadField3(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
...
func (p *UpdateUserinfoItem) ReadField4(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
...
func (p *UpdateUserinfoItem) ReadField5(iprot thrift.TProtocol) error {
	_, _, size, err := iprot.ReadMapBegin()
	if err != nil {
		return thrift.PrependError("error reading map begin: ", err)
	}
...
func (p *UpdateUserinfoItem) Write(oprot thrift.TProtocol) error {
	if err := oprot.WriteStructBegin("update_userinfo_item"); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err)
	}
	if p != nil {
		if err := p.writeField1(oprot); err != nil {
...
func (p *UpdateUserinfoItem) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *UpdateUserinfoItem) writeField2(oprot thrift.TProtocol) (err error) {
...
func (p *UpdateUserinfoItem) writeField3(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("new_value", thrift.STRING, 3); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field begin error 3:new_value: ", p), err)
	}
	if err := oprot.WriteString(string(p.NewValue_)); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T.new_value (3) field write error: ", p), err)
	}
	if err := oprot.WriteFieldEnd(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field end error 3:new_value: ", p), err)
	}
	return err
}

func (p *UpdateUserinfoItem) writeField4(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("old_value", thrift.STRING, 4); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field begin error 4:old_value: ", p), err)
	}
	if err := oprot.WriteString(string(p.OldValue)); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T.old_value (4) field write error: ", p), err)
	}
	if err := oprot.WriteFieldEnd(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field end error 4:old_value: ", p), err)
	}
	return err
}

func (p *UpdateUserinfoItem) writeField5(oprot thrift.TProtocol) (err error) {
...
func (p *UpdateUserinfoItem) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("UpdateUserinfoItem(%+v)", *p)
}
...
func (p *Question) ReadField2(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Images = append(p.Images, _elem7)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *Question) ReadField3(iprot thrift.TProtocol) error {
	...
	p.Options = tSlice
	for i := 0; i < size; i++ {
		_elem8 := &QuestionOption{}
		if err := _elem8.Read(iprot); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", _elem8), err)
		}
		p.Options = append(p.Options, _elem8)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *SearchHits) ReadField3(iprot thrift.TProtocol) error {
	...
	p.Hits = tSlice
	for i := 0; i < size; i++ {
		_elem12 := &SearchHitsItem{}
		if err := _elem12.Read(iprot); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", _elem12), err)
		}
		p.Hits = append(p.Hits, _elem12)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *GradeSubject) ReadField5(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Subjects = append(p.Subjects, _elem14)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *WechatUserinfo) ReadField8(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Privilege = append(p.Privilege, _elem17)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
