...
type IdentByIidRes struct {
  Rescode rescode.Code `thrift:"rescode,1" db:"rescode" json:"rescode"`
  Resmsg string `thrift:"resmsg,2" db:"resmsg" json:"resmsg"`
  Result_ *common.BaiduIdentItem `thrift:"result,3" db:"result" json:"result"`
  Extra map[string]string `thrift:"extra,4" db:"extra" json:"extra"`
}
...
var IdentByIidRes_Result__DEFAULT *common.BaiduIdentItem
func (p *IdentByIidRes) GetResult_() *common.BaiduIdentItem {
  if !p.IsSetResult_() {
...
func (p *IdentByIidRes)  ReadField3(iprot thrift.TProtocol) error {
  p.Result_ = &common.BaiduIdentItem{}
...
type IdentListRes struct {
  Rescode rescode.Code `thrift:"rescode,1" db:"rescode" json:"rescode"`
  Resmsg string `thrift:"resmsg,2" db:"resmsg" json:"resmsg"`
  Results []*common.BaiduIdentItem `thrift:"results,3" db:"results" json:"results"`
  Extra map[string]string `thrift:"extra,4" db:"extra" json:"extra"`
}
...
func (p *IdentListRes) GetResults() []*common.BaiduIdentItem {
  return p.Results
}
...
func (p *IdentListRes)  ReadField3(iprot thrift.TProtocol) error {
  ...
  tSlice := make([]*common.BaiduIdentItem, 0, size)
  p.Results =  tSlice
  for i := 0; i < size; i ++ {
    _elem138 := &common.BaiduIdentItem{}
