...
var CodeReq_Auth_DEFAULT *Authorize

func (p *CodeReq) GetAuth() *Authorize {
	if !p.IsSetAuth() {
...
var VerifyCodeReq_Auth_DEFAULT *Authorize

func (p *VerifyCodeReq) GetAuth() *Authorize {
	if !p.IsSetAuth() {
...
func (p *CodenodeServiceClient) VerifyCode(ctx context.Context, req *VerifyCodeReq) (r *VerifyCodeRes, err error) {
	var _args12 CodenodeServiceVerifyCodeArgs
	_args12.Req = req
	var _result13 CodenodeServiceVerifyCodeResult
	if err = p.Client_().Call(ctx, "verify_code", &_args12, &_result13); err != nil {
		return
	}
