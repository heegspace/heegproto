...
type BaiduIdcardIdentReq struct {
  UID int64 `thrift:"uid,1" db:"uid" json:"uid"`
  IdcardSide string `thrift:"idcard_side,2" db:"idcard_side" json:"idcard_side"`
  ImageBase64 string `thrift:"image_base64,3" db:"image_base64" json:"image_base64"`
  Extra map[string]string `thrift:"extra,4" db:"extra" json:"extra"`
}

func NewBaiduIdcardIdentReq() *BaiduIdcardIdentReq {
  return &BaiduIdcardIdentReq{}
}


func (p *BaiduIdcardIdentReq) GetUID() int64 {
  return p.UID
}

func (p *BaiduIdcardIdentReq) GetIdcardSide() string {
  return p.IdcardSide
}

func (p *BaiduIdcardIdentReq) GetImageBase64() string {
  return p.ImageBase64
}

func (p *BaiduIdcardIdentReq) GetExtra() map[string]string {
  return p.Extra
}
func (p *BaiduIdcardIdentReq) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *BaiduIdcardIdentReq)  ReadField1(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(); err != nil {
  return thrift.PrependError("error reading field 1: ", err)
} else {
  p.UID = v
...
func (p *BaiduIdcardIdentReq)  ReadField2(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(); err != nil {
  return thrift.PrependError("error reading field 2: ", err)
} else {
  p.IdcardSide = v
...
func (p *BaiduIdcardIdentReq)  ReadField3(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(); err != nil {
  return thrift.PrependError("error reading field 3: ", err)
} else {
  p.ImageBase64 = v
...
func (p *BaiduIdcardIdentReq)  ReadField4(iprot thrift.TProtocol) error {
  _, _, size, err := iprot.ReadMapBegin()
  if err != nil {
    return thrift.PrependError("error reading map begin: ", err)
  }
...
func (p *BaiduIdcardIdentReq) Write(oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin("baidu_idcard_ident_req"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField1(oprot); err != nil { return err }
    if err := p.writeField2(oprot); err != nil { return err }
...
func (p *BaiduIdcardIdentReq) writeField1(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("uid", thrift.I64, 1); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:uid: ", p), err) }
  if err := oprot.WriteI64(int64(p.UID)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.uid (1) field write error: ", p), err) }
...
func (p *BaiduIdcardIdentReq) writeField2(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("idcard_side", thrift.STRING, 2); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 2:idcard_side: ", p), err) }
  if err := oprot.WriteString(string(p.IdcardSide)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.idcard_side (2) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 2:idcard_side: ", p), err) }
  return err
}

func (p *BaiduIdcardIdentReq) writeField3(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("image_base64", thrift.STRING, 3); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 3:image_base64: ", p), err) }
  if err := oprot.WriteString(string(p.ImageBase64)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.image_base64 (3) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 3:image_base64: ", p), err) }
  return err
}

func (p *BaiduIdcardIdentReq) writeField4(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("extra", thrift.MAP, 4); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 4:extra: ", p), err) }
  if err := oprot.WriteMapBegin(thrift.STRING, thrift.STRING, len(p.Extra)); err != nil {
    return thrift.PrependError("error writing map begin: ", err)
...
func (p *BaiduIdcardIdentReq) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("BaiduIdcardIdentReq(%+v)", *p)
}
...
type BaiduIdcardIdentRes struct {
  Rescode rescode.Code `thrift:"rescode,1" db:"rescode" json:"rescode"`
  Resmsg string `thrift:"resmsg,2" db:"resmsg" json:"resmsg"`
  Ident *common.BaiduIdcardIdent `thrift:"ident,3" db:"ident" json:"ident"`
  Extra map[string]string `thrift:"extra,4" db:"extra" json:"extra"`
}

func NewBaiduIdcardIdentRes() *BaiduIdcardIdentRes {
  return &BaiduIdcardIdentRes{}
}


func (p *BaiduIdcardIdentRes) GetRescode() rescode.Code {
  return p.Rescode
}

func (p *BaiduIdcardIdentRes) GetResmsg() string {
  return p.Resmsg
}
var BaiduIdcardIdentRes_Ident_DEFAULT *common.BaiduIdcardIdent
func (p *BaiduIdcardIdentRes) GetIdent() *common.BaiduIdcardIdent {
  if !p.IsSetIdent() {
    return BaiduIdcardIdentRes_Ident_DEFAULT
  }
return p.Ident
}

func (p *BaiduIdcardIdentRes) GetExtra() map[string]string {
  return p.Extra
}
func (p *BaiduIdcardIdentRes) IsSetIdent() bool {
  return p.Ident != nil
}

func (p *BaiduIdcardIdentRes) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *BaiduIdcardIdentRes)  ReadField1(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(); err != nil {
  return thrift.PrependError("error reading field 1: ", err)
} else {
  temp := rescode.Code(v)
...
func (p *BaiduIdcardIdentRes)  ReadField2(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(); err != nil {
  return thrift.PrependError("error reading field 2: ", err)
} else {
  p.Resmsg = v
...
func (p *BaiduIdcardIdentRes)  ReadField3(iprot thrift.TProtocol) error {
  p.Ident = &common.BaiduIdcardIdent{}
  if err := p.Ident.Read(iprot); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.Ident), err)
  }
  return nil
}

func (p *BaiduIdcardIdentRes)  ReadField4(iprot thrift.TProtocol) error {
  _, _, size, err := iprot.ReadMapBegin()
  if err != nil {
    return thrift.PrependError("error reading map begin: ", err)
  }
...
func (p *BaiduIdcardIdentRes) Write(oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin("baidu_idcard_ident_res"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField1(oprot); err != nil { return err }
    if err := p.writeField2(oprot); err != nil { return err }
...
func (p *BaiduIdcardIdentRes) writeField1(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("rescode", thrift.I32, 1); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:rescode: ", p), err) }
  if err := oprot.WriteI32(int32(p.Rescode)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.rescode (1) field write error: ", p), err) }
...
func (p *BaiduIdcardIdentRes) writeField2(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("resmsg", thrift.STRING, 2); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 2:resmsg: ", p), err) }
  if err := oprot.WriteString(string(p.Resmsg)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.resmsg (2) field write error: ", p), err) }
...
func (p *BaiduIdcardIdentRes) writeField3(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("ident", thrift.STRUCT, 3); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 3:ident: ", p), err) }
  if err := p.Ident.Write(oprot); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T error writing struct: ", p.Ident), err)
  }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 3:ident: ", p), err) }
  return err
}

func (p *BaiduIdcardIdentRes) writeField4(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("extra", thrift.MAP, 4); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 4:extra: ", p), err) }
  if err := oprot.WriteMapBegin(thrift.STRING, thrift.STRING, len(p.Extra)); err != nil {
    return thrift.PrependError("error writing map begin: ", err)
...
func (p *BaiduIdcardIdentRes) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("BaiduIdcardIdentRes(%+v)", *p)
}
...
type DartynodeService interface {
  ...
  // Parameters:
  //  - Req
  BaiduIdcardIdent(ctx context.Context, req *BaiduIdcardIdentReq) (r *BaiduIdcardIdentRes, err error)
}
...
func (p *DartynodeServiceClient) LoginWechat(ctx context.Context, req *LoginWechatReq) (r *LoginWechatRes, err error) {
  var _args45 DartynodeServiceLoginWechatArgs
  _args45.Req = req
  var _result46 DartynodeServiceLoginWechatResult
  if err = p.Client_().Call(ctx, "login_wechat", &_args45, &_result46); err != nil {
    return
  }
...
func (p *DartynodeServiceClient) RefreshWechat(ctx context.Context, req *RefreshWechatReq) (r *RefreshWechatRes, err error) {
  var _args47 DartynodeServiceRefreshWechatArgs
  _args47.Req = req
  var _result48 DartynodeServiceRefreshWechatResult
  if err = p.Client_().Call(ctx, "refresh_wechat", &_args47, &_result48); err != nil {
    return
  }
...
func (p *DartynodeServiceClient) LogoutWechat(ctx context.Context, req *LogoutWechatReq) (r *LogoutWechatRes, err error) {
  var _args49 DartynodeServiceLogoutWechatArgs
  _args49.Req = req
  var _result50 DartynodeServiceLogoutWechatResult
  if err = p.Client_().Call(ctx, "logout_wechat", &_args49, &_result50); err != nil {
    return
  }
...
func (p *DartynodeServiceClient) UserinfoWechat(ctx context.Context, req *UserinfoWechatReq) (r *UserinfoWechatRes, err error) {
  var _args51 DartynodeServiceUserinfoWechatArgs
  _args51.Req = req
  var _result52 DartynodeServiceUserinfoWechatResult
  if err = p.Client_().Call(ctx, "userinfo_wechat", &_args51, &_result52); err != nil {
    return
  }
...
func (p *DartynodeServiceClient) LoginAlipay(ctx context.Context, req *LoginAlipayReq) (r *LoginAlipayRes, err error) {
  var _args53 DartynodeServiceLoginAlipayArgs
  _args53.Req = req
  var _result54 DartynodeServiceLoginAlipayResult
  if err = p.Client_().Call(ctx, "login_alipay", &_args53, &_result54); err != nil {
    return
  }
...
func (p *DartynodeServiceClient) RefreshAlipay(ctx context.Context, req *RefreshAlipayReq) (r *RefreshAlipayRes, err error) {
  var _args55 DartynodeServiceRefreshAlipayArgs
  _args55.Req = req
  var _result56 DartynodeServiceRefreshAlipayResult
  if err = p.Client_().Call(ctx, "refresh_alipay", &_args55, &_result56); err != nil {
    return
  }
...
func (p *DartynodeServiceClient) LogoutAlipay(ctx context.Context, req *LogoutAlipayReq) (r *LogoutAlipayRes, err error) {
  var _args57 DartynodeServiceLogoutAlipayArgs
  _args57.Req = req
  var _result58 DartynodeServiceLogoutAlipayResult
  if err = p.Client_().Call(ctx, "logout_alipay", &_args57, &_result58); err != nil {
    return
  }
...
func (p *DartynodeServiceClient) UserinfoAlipay(ctx context.Context, req *UserinfoAlipayReq) (r *UserinfoAlipayRes, err error) {
  var _args59 DartynodeServiceUserinfoAlipayArgs
  _args59.Req = req
  var _result60 DartynodeServiceUserinfoAlipayResult
  if err = p.Client_().Call(ctx, "userinfo_alipay", &_args59, &_result60); err != nil {
    return
  }
...
func (p *DartynodeServiceClient) BaiduEntity(ctx context.Context, req *BaiduEntityReq) (r *BaiduEntityRes, err error) {
  var _args61 DartynodeServiceBaiduEntityArgs
  _args61.Req = req
  var _result62 DartynodeServiceBaiduEntityResult
  if err = p.Client_().Call(ctx, "baidu_entity", &_args61, &_result62); err != nil {
    return
  }
...
func (p *DartynodeServiceClient) BaiduDocAnalysis(ctx context.Context, req *BaiduDocAnalysisReq) (r *BaiduDocAnalysisRes, err error) {
  var _args63 DartynodeServiceBaiduDocAnalysisArgs
  _args63.Req = req
  var _result64 DartynodeServiceBaiduDocAnalysisResult
  if err = p.Client_().Call(ctx, "baidu_doc_analysis", &_args63, &_result64); err != nil {
    return
  }
...
// Parameters:
//  - Req
func (p *DartynodeServiceClient) BaiduIdcardIdent(ctx context.Context, req *BaiduIdcardIdentReq) (r *BaiduIdcardIdentRes, err error) {
  var _args65 DartynodeServiceBaiduIdcardIdentArgs
  _args65.Req = req
  var _result66 DartynodeServiceBaiduIdcardIdentResult
  if err = p.Client_().Call(ctx, "baidu_idcard_ident", &_args65, &_result66); err != nil {
    return
  }
...
func NewDartynodeServiceProcessor(handler DartynodeService) *DartynodeServiceProcessor {
  ...
  self67 := &DartynodeServiceProcessor{handler:handler, processorMap:make(map[string]thrift.TProcessorFunction)}
  self67.processorMap["login_wechat"] = &dartynodeServiceProcessorLoginWechat{handler:handler}
  self67.processorMap["refresh_wechat"] = &dartynodeServiceProcessorRefreshWechat{handler:handler}
  self67.processorMap["logout_wechat"] = &dartynodeServiceProcessorLogoutWechat{handler:handler}
  self67.processorMap["userinfo_wechat"] = &dartynodeServiceProcessorUserinfoWechat{handler:handler}
  self67.processorMap["login_alipay"] = &dartynodeServiceProcessorLoginAlipay{handler:handler}
  self67.processorMap["refresh_alipay"] = &dartynodeServiceProcessorRefreshAlipay{handler:handler}
  self67.processorMap["logout_alipay"] = &dartynodeServiceProcessorLogoutAlipay{handler:handler}
  self67.processorMap["userinfo_alipay"] = &dartynodeServiceProcessorUserinfoAlipay{handler:handler}
  self67.processorMap["baidu_entity"] = &dartynodeServiceProcessorBaiduEntity{handler:handler}
  self67.processorMap["baidu_doc_analysis"] = &dartynodeServiceProcessorBaiduDocAnalysis{handler:handler}
  self67.processorMap["baidu_idcard_ident"] = &dartynodeServiceProcessorBaiduIdcardIdent{handler:handler}
return self67
}
...
type dartynodeServiceProcessorBaiduIdcardIdent struct {
  handler DartynodeService
}

func (p *dartynodeServiceProcessorBaiduIdcardIdent) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  args := DartynodeServiceBaiduIdcardIdentArgs{}
  if err = args.Read(iprot); err != nil {
    iprot.ReadMessageEnd()
    x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
    oprot.WriteMessageBegin("baidu_idcard_ident", thrift.EXCEPTION, seqId)
    x.Write(oprot)
    oprot.WriteMessageEnd()
    oprot.Flush(ctx)
    return false, err
  ...
  iprot.ReadMessageEnd()
  result := DartynodeServiceBaiduIdcardIdentResult{}
var retval *BaiduIdcardIdentRes
  var err2 error
  if retval, err2 = p.handler.BaiduIdcardIdent(ctx, args.Req); err2 != nil {
    x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing baidu_idcard_ident: " + err2.Error())
    oprot.WriteMessageBegin("baidu_idcard_ident", thrift.EXCEPTION, seqId)
    x.Write(oprot)
    oprot.WriteMessageEnd()
    oprot.Flush(ctx)
  ...
  if err2 = oprot.WriteMessageBegin("baidu_idcard_ident", thrift.REPLY, seqId); err2 != nil {
    err = err2
  }
  if err2 = result.Write(oprot); err == nil && err2 != nil {
    err = err2
...
// Attributes:
//  - Req
type DartynodeServiceBaiduIdcardIdentArgs struct {
  Req *BaiduIdcardIdentReq `thrift:"req,1" db:"req" json:"req"`
}

func NewDartynodeServiceBaiduIdcardIdentArgs() *DartynodeServiceBaiduIdcardIdentArgs {
  return &DartynodeServiceBaiduIdcardIdentArgs{}
}

var DartynodeServiceBaiduIdcardIdentArgs_Req_DEFAULT *BaiduIdcardIdentReq
func (p *DartynodeServiceBaiduIdcardIdentArgs) GetReq() *BaiduIdcardIdentReq {
  if !p.IsSetReq() {
    return DartynodeServiceBaiduIdcardIdentArgs_Req_DEFAULT
  }
return p.Req
}
func (p *DartynodeServiceBaiduIdcardIdentArgs) IsSetReq() bool {
  return p.Req != nil
}

func (p *DartynodeServiceBaiduIdcardIdentArgs) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *DartynodeServiceBaiduIdcardIdentArgs)  ReadField1(iprot thrift.TProtocol) error {
  p.Req = &BaiduIdcardIdentReq{}
  if err := p.Req.Read(iprot); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.Req), err)
  }
  return nil
...
func (p *DartynodeServiceBaiduIdcardIdentArgs) Write(oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin("baidu_idcard_ident_args"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField1(oprot); err != nil { return err }
  }
...
func (p *DartynodeServiceBaiduIdcardIdentArgs) writeField1(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:req: ", p), err) }
  if err := p.Req.Write(oprot); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T error writing struct: ", p.Req), err)
...
func (p *DartynodeServiceBaiduIdcardIdentArgs) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("DartynodeServiceBaiduIdcardIdentArgs(%+v)", *p)
}

// Attributes:
//  - Success
type DartynodeServiceBaiduIdcardIdentResult struct {
  Success *BaiduIdcardIdentRes `thrift:"success,0" db:"success" json:"success,omitempty"`
}

func NewDartynodeServiceBaiduIdcardIdentResult() *DartynodeServiceBaiduIdcardIdentResult {
  return &DartynodeServiceBaiduIdcardIdentResult{}
}

var DartynodeServiceBaiduIdcardIdentResult_Success_DEFAULT *BaiduIdcardIdentRes
func (p *DartynodeServiceBaiduIdcardIdentResult) GetSuccess() *BaiduIdcardIdentRes {
  if !p.IsSetSuccess() {
    return DartynodeServiceBaiduIdcardIdentResult_Success_DEFAULT
  }
return p.Success
}
func (p *DartynodeServiceBaiduIdcardIdentResult) IsSetSuccess() bool {
  return p.Success != nil
}

func (p *DartynodeServiceBaiduIdcardIdentResult) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *DartynodeServiceBaiduIdcardIdentResult)  ReadField0(iprot thrift.TProtocol) error {
  p.Success = &BaiduIdcardIdentRes{}
  if err := p.Success.Read(iprot); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.Success), err)
  }
  return nil
...
func (p *DartynodeServiceBaiduIdcardIdentResult) Write(oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin("baidu_idcard_ident_result"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField0(oprot); err != nil { return err }
  }
...
func (p *DartynodeServiceBaiduIdcardIdentResult) writeField0(oprot thrift.TProtocol) (err error) {
  if p.IsSetSuccess() {
    if err := oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 0:success: ", p), err) }
    if err := p.Success.Write(oprot); err != nil {
...
func (p *DartynodeServiceBaiduIdcardIdentResult) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("DartynodeServiceBaiduIdcardIdentResult(%+v)", *p)
}
