...
var NormalUserReq_Auth_DEFAULT *common.Authorize

func (p *NormalUserReq) GetAuth() *common.Authorize {
	if !p.IsSetAuth() {
...
var CooperatorUserReq_Auth_DEFAULT *common.Authorize

func (p *CooperatorUserReq) GetAuth() *common.Authorize {
	if !p.IsSetAuth() {
